...
fun CreateAccountContent(
    ...
    Column(modifier = Modifier
        ...
        Header(
            ...
            navigateBack = { actioner(CreateAccountAction.NavigateBack) }
        )
        ...
        Box(modifier = Modifier
            ...
            Column(modifier = Modifier
                ...
                // First Page
                if (!viewState.showCreatePasswordScreen) {
                    ...
                    OutlinedTextField(modifier = Modifier
                        ...
                        onValueChange = { newFirstName -> actioner(CreateAccountAction.UpdateFirstName(newFirstName)) },
                        placeholder = {
                            Text(
                    ...
                    OutlinedTextField(modifier = Modifier
                        ...
                        onValueChange = { newLastName -> actioner(CreateAccountAction.UpdateLastName(newLastName)) },
                        placeholder = {
                            Text(
                    ...
                    OutlinedTextField(modifier = Modifier
                        ...
                        onValueChange = { newEmail -> actioner(CreateAccountAction.UpdateEmail(newEmail)) },
                        placeholder = {
                            Text(
                    ...
                    OutlinedTextField(modifier = Modifier
                        ...
                        onValueChange = { newPhone -> actioner(CreateAccountAction.UpdatePhone(newPhone)) },
                        placeholder = {
                            Text(
                    ...
                    OutlinedTextField(modifier = Modifier
                        ...
                        onValueChange = { newCountry -> actioner(CreateAccountAction.UpdateCountry(newCountry)) },
                        placeholder = {
                            Text(
                    ...
                    OutlinedTextField(modifier = Modifier
                        ...
                        onValueChange = { newProvince -> actioner(CreateAccountAction.UpdateProvince(newProvince)) },
                        placeholder = {
                            Text(
                    ...
                    OutlinedTextField(modifier = Modifier
                        ...
                        onValueChange = { newCity -> actioner(CreateAccountAction.UpdateCity(newCity)) },
                        placeholder = {
                            Text(
                    ...
                    OutlinedTextField(modifier = Modifier
                        ...
                        onValueChange = { newAddress -> actioner(CreateAccountAction.UpdateAddress(newAddress)) },
                        placeholder = {
                            Text(
                ...
                // Second Page
                    ...
                    Row() {
                        Icon(painter = painterResource(id = R.drawable.icon_check_circle),
                    ...
                    Row() {
                        Icon(painter = painterResource(id = R.drawable.check_box_empty),
                            tint = Color.Unspecified,
                            contentDescription = null
                        )
